...
class Button extends Component {
  ...
  render() {
    const { title, icon, style, disabled, backgroundColor, round, size } = this.props;
    let { buttonStyles, hoverStyles, hover } = this.state;
    ...
    return (
      <div className={rootClass} style={styles} onClick={this.handleClick} onMouseEnter={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave}>
